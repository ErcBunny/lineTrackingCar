...
void control()
{
    ...
    if (runFlag && calculatePid)
    {
        ...
        setpoint_L = (speedStd + posOutput) * curve(timeStep * 0.1);
        setpoint_R = (speedStd - posOutput) * curve(timeStep * 0.1);
        /*
